#!/usr/local/bin/lua
SUITE_NAME = "print_tokens"
CASE_NUM = 4130

VERSION_NUM = 7 --total counted to 7 versions
	...
	then
		...
		for j =1, line_num do
			...
			if string.find(tmp, "/source/") ~= nil then
				...
				tmp = tmp.."\n cd ../versions.alt/versions.orig/v"..i.."/ && gcov print_tokens.c"
				tmp = tmp.."\n mv print_tokens.c.gcov ../../../traces/v"..i.."/cov_t"..k
				k = k + 1
				tmp = tmp.."\n rm print_tokens.gcda && cd ../../../scripts/\n"
			end
			file:write(tmp.."\n")
			tmp = ""
		end
